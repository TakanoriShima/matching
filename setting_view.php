           ...
           <div class="wrapper mt-3">
                ...
                <form action="create_profile.php" method="POST" class="mt-5" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nickname" id="nickname" placeholder="ニックネームを入力してください">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2 pt-2">
                            <input type="radio" value="普通に飲む" name="drink" id="drink_medium" checked>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2 pt-2">
                            <input type="radio" value="たまに吸う" name="smoking" id="smoke_meduim" checked>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="introduction" id="introduction" rows="20" placeholder="1000文字以内のプロフィールを入力してください"></textarea>
